...
public class OrderCreateCommandHandler {
    ...
    public CreateOrderResponse createOrder(CreateOrderCommand createOrderCommand) {
        ...
        OrderCreatedEvent orderCreatedEvent = orderDomainService.validateAndInitialOrder(order, restaurant);
        Order orderResult =saveOrder(order);
        log.info("Order is created with orderId: {}",orderResult.getId().getValue());
        CreateOrderResponse createOrderResponse = orderDataMapper.orderToCreateOrderResponse(order, "");
    ...
    private Restaurant checkRestaurant(CreateOrderCommand createOrderCommand) {
        ...
        if(restaurantInformation.isEmpty()){
            ...
            throw new OrderDomainException("Could not find restaurant with restaurantId: "+restaurant);
        }
    ...
    private void checkCustomer(UUID customerId) {
        ...
        if(customer.isEmpty()){
         ...
         throw new OrderDomainException("Could not find customer with customerId: "+customer);
        }
    }
